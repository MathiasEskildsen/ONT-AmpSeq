...
rule phyloseq_abund_sintax:
    ...
    log: 
        os.path.join(config['log_dir'], "11-prep_for_phyloseq", "phyloseq_abund_sintax",'phyloseq_{id}.log')
    threads:
        1
    conda:
        "../envs/generic.yml"
...
rule phyloseq_sintax:
    ...
    log:
        os.path.join(config['log_dir'], "11-prep_for_phyloseq", "phyloseq_sintax",'phyloseq_{id}.log')
    threads:
        1
    resources:
        mem_mb = 1024,
