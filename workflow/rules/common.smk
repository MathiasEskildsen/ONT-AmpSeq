        ...
        inputs.extend(
            expand(
                os.path.join(
                    ...
                    "final",
                    "{id}",
                    "OTUtable_tax_{id}_blast_full.tsv",
                ),
                id=ids,
            )
        )
        ...
        inputs.extend(
            expand(
                os.path.join(
                    ...
                    "final",
                    "{id}",
                    "phyloseq_abundance_{id}_blast.tsv",
                ),
                id=ids,
            )
        )
